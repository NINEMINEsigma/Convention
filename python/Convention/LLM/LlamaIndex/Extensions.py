...
class PythonExecuteTool(BaseModel):
...
_PythonExecuteTool = PythonExecuteTool()
PythonExecuteTools = [FunctionTool.from_defaults(
    async_fn=_PythonExecuteTool.execute,
    name=_PythonExecuteTool.name,
    description=_PythonExecuteTool.description,
    fn_schema=PythonExecuteTool
    )]
