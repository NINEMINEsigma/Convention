...
CEObject* CEObject::CreateObject() const
{
	return new CEObject();
}

CEObject* CEObject::Instantiate() const
{
	CEObject* result = CreateObject();
	CloneValuesTo(result);
	return result;
}

void CEObject::CloneValuesTo(_In_ CEObject* target) const
{
